...
function create_fragment$2(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			svg0 = claim_svg_element(div1_nodes, "svg", {
				xmlns: true,
				width: true,
				height: true,
				viewBox: true
			...
			svg1 = claim_svg_element(div2_nodes, "svg", {
				xmlns: true,
				width: true,
				height: true,
				viewBox: true
		...
		h() {
			...
			attr(div1, "class", "prev svelte-1pz7yb1");
			set_style(div1, "width", "25%");
			...
			attr(div2, "class", "next svelte-1pz7yb1");
			set_style(div2, "width", "25%");
			attr(div3, "class", "deckWrapper svelte-1pz7yb1");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(div1, "keypress", /*handlePrev*/ ctx[3]),
					listen(div1, "click", /*handlePrev*/ ctx[3]),
					listen(div2, "keypress", /*handleNext*/ ctx[2]),
					listen(div2, "click", /*handleNext*/ ctx[2]),
					action_destroyer(swipable.call(null, div3, { length: 50 })),
					listen(div3, "swiperight", /*handlePrev*/ ctx[3]),
					listen(div3, "swipeleft", /*handleNext*/ ctx[2])
				];
